...
public class QuadrangleTest {
    ...
    public void isComputableTest() throws PointException {
        ...
        assertThat(new Rectangle(points1).isComputabble()).isTrue();
        ...
        assertThat(new Rectangle(points2).isComputabble()).isFalse();
        ...
        assertThat(new Rectangle(points3).isComputabble()).isFalse();
    }
}
