...
public class UtilsTest {
    ...
    public void coordInBoundaryCheck_ordinal(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("0,5", "15,24"));
        assertThat(Utils.coordInBoundaryCheck(coordinates), is(true));
    }

    @Test(expected = RuntimeException.class)
    public void coordInBoundaryCheck_exception(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("2,25", "3,2"));
    ...
    public void inputParser(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("1,2", "3,4"));
    ...
    public void duplicatedCheck_exception(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("1,2", "1,2"));
    ...
    public void isValidCoordinate_upperLimitException(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("1,2", "1,25"));
        Utils.isValidCoordinate(coordinates);
    }

    @Test(expected = RuntimeException.class)
    public void isValidCoordinate_lowerLimitException(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("0,1", "1,-1"));
        Utils.isValidCoordinate(coordinates);
    }

    @Test
    public void checkReturnCoordinates_ordinal(){
        List<String> coordinates = new ArrayList<>(Arrays.asList("0,1", "3,4"));
